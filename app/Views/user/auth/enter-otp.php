            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="login-box">
                        ...
                        <form name="forgotEmail" action="<?= route_to('user.verifyOtp') ?>" method="post" onsubmit="return validateForm()">
                            <?= csrf_field() ?>
                            <div class="account-form-group">
                                <input type="text" placeholder="Enter OTP" name="otp" pattern="[0-9]{6}" minlength="6" maxlength="6" required>
                                <i class="fa fa-user"></i>
                                <?php if (session()->has('errors') && isset(session('errors')['otp'])) : ?>
                                    <div class="input-error">
                                        <?php echo esc(session('errors')['otp']); ?>
                                    </div>
                                <?php endif; ?>
                            </div>
                            <p>
                                <button type="submit" class="gauto-theme-btn">Submit OTP</button>
                            </p>
                        </form>
